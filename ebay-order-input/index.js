//This is to work on the copy and paste issue
...
function nextOrderBtn() {
   ...
   var filePath = "http://127.0.0.1:5502/master-ebay-order-data.json";//Testing address = http://127.0.0.1:5500/order-data.json
