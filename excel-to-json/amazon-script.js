...
setInterval(function() {
 ...
      fs.writeFileSync("C:/Users/mick.CROSSCREEK100/Cross Creek Tractor Co., Inc/Ecommerce Digital Marketing Team - Documents/Amazon Order Input Program/temp-amazon-order-data.json", JSON.stringify(data, null, 2));
      console.log(mostRecentFile + " - Amazon file written successfully!");
      fs.readFile('C:/Users/mick.CROSSCREEK100/Cross Creek Tractor Co., Inc/Ecommerce Digital Marketing Team - Documents/Amazon Order Input Program/temp-amazon-order-data.json', (err, data) => {
        if (err) throw err;
 ...
        let masterData = JSON.parse(fs.readFileSync('C:/Users/mick.CROSSCREEK100/Cross Creek Tractor Co., Inc/Ecommerce Digital Marketing Team - Documents/Amazon Order Input Program/master-amazon-order-data.json'));
 ...
    fs.writeFileSync('C:/Users/mick.CROSSCREEK100/Cross Creek Tractor Co., Inc/Ecommerce Digital Marketing Team - Documents/Amazon Order Input Program/master-amazon-order-data.json', JSON.stringify(masterData, null, 2), (err) => {
      if (err) throw err;
